...
public class PrefManager {
    ...
    public boolean getshowDialogSecurity( ){
        return pref.getBoolean("dialogSecurity",false);
    ...
    public void setshowDialogSecurity(boolean first){
        editor.putBoolean("dialogSecurity",first);
        editor.apply();
    }
