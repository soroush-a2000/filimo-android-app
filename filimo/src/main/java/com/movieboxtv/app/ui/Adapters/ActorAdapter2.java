...
public class ActorAdapter2 extends  RecyclerView.Adapter<ActorAdapter2.ActorHolder>{
        private List<Actor> actorList;
        private Activity activity;
        public ActorAdapter2(List<Actor> actorList, Activity activity) {
            this.actorList = actorList;
            this.activity = activity;
        }
        @Override
        public ActorHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_actor2 , null);
