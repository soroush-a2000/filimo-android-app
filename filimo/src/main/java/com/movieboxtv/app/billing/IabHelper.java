...
package com.movieboxtv.app.billing;
...
public class IabHelper {
    ...
    static final String MYKET_SERVICE_ACTION = "ir.mservices.market.InAppBillingService.BIND";
    static final String MYKET_NAMESPACE = "ir.mservices.market";
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                if (Config.PAYMENT_MOD == 1) {
                    if (!getMarketNamespace(2).equals(name.getPackageName())) {
                        Toast.makeText(mContext, "ابتدا برنامه هک پرداخت درون برنامه ای را حذف و سپس اقدام به خرید کنید!", Toast.LENGTH_LONG).show();
                        return;
                    } else {
                    ...
                    if (!getMarketNamespace(4).equals(name.getPackageName())) {
                        Toast.makeText(mContext, "ابتدا برنامه هک پرداخت درون برنامه ای را حذف و سپس اقدام به خرید کنید!", Toast.LENGTH_LONG).show();
                        return;
                    } else {
                        mService = IInAppBillingService.Stub.asInterface(service);
        ...
        if (Config.PAYMENT_MOD == 1) {
            serviceIntent = new Intent(getMarketAction(2));
            serviceIntent.setPackage(getMarketNamespace(2));
        } else if (Config.PAYMENT_MOD == 2) {
            serviceIntent = new Intent(getMarketAction(4));
            serviceIntent.setPackage(getMarketNamespace(4));
        }
    ...
    String getMarketNamespace(int market) {
        switch (market) {
            ...
            case MARKET_PLAY:
                return PLAY_NAMESPACE;
            case MARKET_MYKET:
                return MYKET_NAMESPACE;
            default:
                return "";
        }
    }
